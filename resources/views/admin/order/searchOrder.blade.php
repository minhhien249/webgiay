         ...
         <form role="form" action="{{url('admin/searchOrder')}}" method="get"  enctype="multipart/form-data">
            <div class="row">
                <div class="col-5">
                    ...
                    <input type="search" id="search" class="form-control form-control-sm" name="keyword" placeholder="Nhập từ khóa tìm kiếm" value="{{$keyword}}" aria-controls="datatable-buttons" style= "height:39px;padding-left: 35px;">
                </div>
                <div class="col-3">
